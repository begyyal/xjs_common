...
export namespace UObj {
     ...
     */
    export function array2record<K extends IndexSignature, V>(keyOrValues: K[], op: { vgen: (k: K) => V }): Record<K, V>;
    export function array2record<K extends IndexSignature, V>(keyOrValues: V[], op: { kgen: (v: V) => K }): Record<K, V>;
    export function array2record<K extends IndexSignature, V>(keyOrValues: (K[] | V[]), op: { kgen?: (v: V) => K, vgen?: (k: K) => V }): Record<K, V> {
